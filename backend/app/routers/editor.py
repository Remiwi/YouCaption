...
async def addNewBlock(request: Request):
    ...
    new_caption_block = SubtitleBlock(text=body.get('text'), start_time=body.get('startTime'), end_time=body.get('endTime'))
